...
def plot(X, Y, XtA, YtA, title="ClassificationA.png", test=True):
    fig = plt.figure()
    ...
    if not test:
        ...
        ax.plot(XtA[my_members, 0], XtA[my_members, 1],
                'w', markerfacecolor=colors[0], marker = '.')
...
plot(XA, YA, XtA, YtA, title="classificationA.png")
plot(XB, YB, XtB, YtB, title="classificationB.png")
plot(XC, YC, XtC, YtC, title="classificationC.png")
